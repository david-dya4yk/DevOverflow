...
const Stats = ({totalAnswers, totalQuestions, badges}: Props) => {
  return <div className='mt-3'>
    ...
    <div className='mt-5 grid grid-cols-1 gap-5 xs:grid-cols-2 md:grid-cols-4'>
      ...
      <StatsCard imgUrl='/icons/gold-medal.svg' title='Gold Bages' value={badges.gold}/>
      <StatsCard imgUrl='/icons/silver-medal.svg' title='Silver Bages' value={badges.silver}/>
      <StatsCard imgUrl='/icons/bronze-medal.svg' title='Bronze Bages' value={badges.bronze}/>
    </div>
  </div>
}
